...
import { formatCentsToInput, parseBRLToCents, todayISODate } from "@/lib/format";
import {
...
/**
 * "Nova/Editar movimentação" form body (FR-016..FR-022). Rendered inside
 * `TransactionDialog`, which remounts it per target via `key` (and unmounts
 * it on close), so no state leaks between create/edit sessions.
 */
